...
void cfgCallback(lidar_object_detection::objectDetectorRacetrackConfig &config_racetrack, int32_t level) {
    xMinROI = config_racetrack.xMinROI;
    xMaxROI = config_racetrack.xMaxROI;
    yMinROI = config_racetrack.yMinROI;
    yMaxROI = config_racetrack.yMaxROI;
    zMinROI = config_racetrack.zMinROI;
    zMaxROI = config_racetrack.zMaxROI;

    minPoints = config_racetrack.minPoints;
    epsilon = config_racetrack.epsilon;
    minClusterSize = config_racetrack.minClusterSize;
    maxClusterSize = config_racetrack.maxClusterSize;

    xMinBoundingBox = config_racetrack.xMinBoundingBox;
    xMaxBoundingBox = config_racetrack.xMaxBoundingBox;
    yMinBoundingBox = config_racetrack.yMinBoundingBox;
    yMaxBoundingBox = config_racetrack.yMaxBoundingBox;
    zMinBoundingBox = config_racetrack.zMinBoundingBox;
    zMaxBoundingBox = config_racetrack.zMaxBoundingBox;

    leafSize  = config_racetrack.leafSize;

    maxIterations = config_racetrack.maxIterations;
    distanceThreshold = config_racetrack.distanceThreshold;
}
...
int main (int argc, char** argv) {
    // Initialize ROS
    ros::init (argc, argv, "lidar_object_detection_racetrack");
    ros::NodeHandle nh;
    
    dynamic_reconfigure::Server<lidar_object_detection::objectDetectorRacetrackConfig> server;
    dynamic_reconfigure::Server<lidar_object_detection::objectDetectorRacetrackConfig>::CallbackType f;
